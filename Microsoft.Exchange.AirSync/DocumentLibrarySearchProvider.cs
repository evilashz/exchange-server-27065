...
namespace Microsoft.Exchange.AirSync
{
	...
	internal class DocumentLibrarySearchProvider : DisposeTrackableBase, ISearchProvider
	{
		...
		// (get) Token: 0x0600073D RID: 1853 RVA: 0x00026AB6 File Offset: 0x00024CB6
		...
		// (get) Token: 0x0600073E RID: 1854 RVA: 0x00026ABE File Offset: 0x00024CBE
		...
		// Token: 0x06000740 RID: 1856 RVA: 0x00026CEC File Offset: 0x00024EEC
		...
		// Token: 0x06000742 RID: 1858 RVA: 0x000276EC File Offset: 0x000258EC
		...
		// Token: 0x06000743 RID: 1859 RVA: 0x0002789C File Offset: 0x00025A9C
		...
		// Token: 0x06000744 RID: 1860 RVA: 0x000278BB File Offset: 0x00025ABB
		protected override DisposeTracker InternalGetDisposeTracker()
		{
			return DisposeTracker.Get<DocumentLibrarySearchProvider>(this);
		}

		// Token: 0x06000745 RID: 1861 RVA: 0x000278C4 File Offset: 0x00025AC4
		private void BuildResultNode(XmlNode responseNode, object[] row)
		{
			...
			for (int i = 0; i < DocumentLibrarySearchProvider.documentLibraryProps.GetLength(0); i++)
			{
				...
				if (obj != null && !(obj is PropertyError))
				{
					...
					if (<PrivateImplementationDetails>{AB27278A-C276-498D-AAD6-319A054A2659}.$$method0x6000711-1 == null)
					{
						<PrivateImplementationDetails>{AB27278A-C276-498D-AAD6-319A054A2659}.$$method0x6000711-1 = new Dictionary<string, int>(8)
						{
							{
								"LinkId",
								0
					...
					int num;
					if (!<PrivateImplementationDetails>{AB27278A-C276-498D-AAD6-319A054A2659}.$$method0x6000711-1.TryGetValue(key, out num))
					{
						goto IL_1A7;
					}
					switch (num)
