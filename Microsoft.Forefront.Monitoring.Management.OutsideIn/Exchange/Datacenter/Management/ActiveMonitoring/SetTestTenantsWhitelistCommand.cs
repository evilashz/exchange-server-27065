...
namespace Microsoft.Exchange.Datacenter.Management.ActiveMonitoring
{
	...
	public class SetTestTenantsWhitelistCommand : PSCmdlet
	{
		...
		// (get) Token: 0x06000011 RID: 17 RVA: 0x000025CF File Offset: 0x000007CF
		// (set) Token: 0x06000012 RID: 18 RVA: 0x000025D7 File Offset: 0x000007D7
		[Parameter(Mandatory = true)]
		public string[] IPAddresses { get; set; }

		// Token: 0x17000006 RID: 6
		// (get) Token: 0x06000013 RID: 19 RVA: 0x000025E0 File Offset: 0x000007E0
		// (set) Token: 0x06000014 RID: 20 RVA: 0x000025E8 File Offset: 0x000007E8
		[Parameter(Mandatory = false)]
		public string ManagementEndpoint { get; set; }

		// Token: 0x17000007 RID: 7
		// (get) Token: 0x06000015 RID: 21 RVA: 0x000025F1 File Offset: 0x000007F1
		// (set) Token: 0x06000016 RID: 22 RVA: 0x000025F9 File Offset: 0x000007F9
		[Parameter(Mandatory = false)]
		public SwitchParameter Merge { get; set; }

		// Token: 0x17000008 RID: 8
		// (get) Token: 0x06000017 RID: 23 RVA: 0x00002602 File Offset: 0x00000802
		// (set) Token: 0x06000018 RID: 24 RVA: 0x0000260A File Offset: 0x0000080A
		[Parameter(Mandatory = false)]
		...
		// Token: 0x0600001A RID: 26 RVA: 0x00002640 File Offset: 0x00000840
