...
namespace Microsoft.Exchange.Rpc.Cluster
{
	...
	{
		// Token: 0x06000996 RID: 2454 RVA: 0x00016434 File Offset: 0x00015834
		public ReplayRpcClient(string machineName) : base(machineName)
		{
		}

		// Token: 0x06000997 RID: 2455 RVA: 0x00016844 File Offset: 0x00015C44
		...
		// Token: 0x06000998 RID: 2456 RVA: 0x00016B44 File Offset: 0x00015F44
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x06000999 RID: 2457 RVA: 0x000170A8 File Offset: 0x000164A8
		[HandleProcessCorruptedStateExceptions]
		public unsafe RpcErrorExceptionInfo GetCopyStatusEx2(RpcGetDatabaseCopyStatusFlags collectionFlags, Guid[] sgGuids, ref RpcDatabaseCopyStatus[] sgStatuses)
		{
			...
			try
			{
				ptr = <Module>.Microsoft.Exchange.Rpc.Cluster.?A0x5763173e.FromGuidArray(sgGuids, &num2);
		...
		// Token: 0x0600099A RID: 2458 RVA: 0x000171DC File Offset: 0x000165DC
		[HandleProcessCorruptedStateExceptions]
		public unsafe RpcErrorExceptionInfo RpccGetCopyStatusEx4(RpcGetDatabaseCopyStatusFlags2 collectionFlags2, Guid[] dbGuids, ref RpcDatabaseCopyStatus2[] dbStatuses)
		{
			...
			try
			{
				ptr = <Module>.Microsoft.Exchange.Rpc.Cluster.?A0x5763173e.FromGuidArray(dbGuids, &num2);
		...
		// Token: 0x0600099B RID: 2459 RVA: 0x00017468 File Offset: 0x00016868
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x0600099C RID: 2460 RVA: 0x0001759C File Offset: 0x0001699C
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x0600099D RID: 2461 RVA: 0x00017718 File Offset: 0x00016B18
		[HandleProcessCorruptedStateExceptions]
		public unsafe RpcErrorExceptionInfo RpccPrepareDatabaseSeedAndBegin(RpcSeederArgs seederArgs, ref RpcSeederStatus seederStatus)
		{
			...
			int num = <Module>.Microsoft.Exchange.Rpc.Cluster.?A0x5763173e.MToUSeederArgs(seederArgs, &tagSeederArgs);
			if (num < 0)
			{
			...
			try
			{
				...
				seederStatus = <Module>.Microsoft.Exchange.Rpc.Cluster.?A0x5763173e.UToMSeederStatus(ref tagSeederStatus);
				return <Module>.UToMErrorExceptionInfo(ref tagErrorExceptionInfo);
			}
			catch when (endfilter(<Module>.DwExRpcExceptionFilter(Marshal.GetExceptionCode()) != null))
			{
			...
			finally
			{
				...
				<Module>.Microsoft.Exchange.Rpc.Cluster.?A0x5763173e.FreeSeederArgs(&tagSeederArgs);
				<Module>.FreeErrorExceptionInfo(&tagErrorExceptionInfo);
			}
			return null;
		}

		// Token: 0x0600099E RID: 2462 RVA: 0x000177FC File Offset: 0x00016BFC
		[HandleProcessCorruptedStateExceptions]
		public unsafe RpcErrorExceptionInfo RpccPrepareDatabaseSeedAndBegin4(RpcSeederArgs seederArgs, ref RpcSeederStatus seederStatus)
		{
			...
			{
				<Module>.FreeSeederStatus(&tagSeederStatus);
				<Module>.Microsoft.Exchange.Rpc.Cluster.?A0x5763173e.FreeSeederArgs((tagSeederArgs3*)(&tagSeederArgs));
				<Module>.FreeErrorExceptionInfo(&tagErrorExceptionInfo);
			}
			return null;
		}

		// Token: 0x0600099F RID: 2463 RVA: 0x000178E0 File Offset: 0x00016CE0
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009A0 RID: 2464 RVA: 0x00017A8C File Offset: 0x00016E8C
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009A1 RID: 2465 RVA: 0x00017B3C File Offset: 0x00016F3C
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009A2 RID: 2466 RVA: 0x000179C4 File Offset: 0x00016DC4
		[HandleProcessCorruptedStateExceptions]
		public unsafe RpcErrorExceptionInfo RpccGetDatabaseSeedStatus(Guid dbGuid, ref RpcSeederStatus pSeederStatus)
		{
			...
			try
			{
				...
				pSeederStatus = <Module>.Microsoft.Exchange.Rpc.Cluster.?A0x5763173e.UToMSeederStatus(ref tagSeederStatus);
				return <Module>.UToMErrorExceptionInfo(ref tagErrorExceptionInfo);
			}
			catch when (endfilter(<Module>.DwExRpcExceptionFilter(Marshal.GetExceptionCode()) != null))
			{
		...
		// Token: 0x060009A3 RID: 2467 RVA: 0x00017BEC File Offset: 0x00016FEC
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009A4 RID: 2468 RVA: 0x00017CB8 File Offset: 0x000170B8
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009A5 RID: 2469 RVA: 0x00017D88 File Offset: 0x00017188
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009A6 RID: 2470 RVA: 0x00017E58 File Offset: 0x00017258
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009A7 RID: 2471 RVA: 0x00016934 File Offset: 0x00015D34
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009A8 RID: 2472 RVA: 0x00016A28 File Offset: 0x00015E28
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009A9 RID: 2473 RVA: 0x00016C24 File Offset: 0x00016024
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009AA RID: 2474 RVA: 0x00016D04 File Offset: 0x00016104
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009AB RID: 2475 RVA: 0x00016DF4 File Offset: 0x000161F4
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009AC RID: 2476 RVA: 0x00016ED4 File Offset: 0x000162D4
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009AD RID: 2477 RVA: 0x00016FC8 File Offset: 0x000163C8
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009AE RID: 2478 RVA: 0x00017644 File Offset: 0x00016A44
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009AF RID: 2479 RVA: 0x00017F28 File Offset: 0x00017328
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009B0 RID: 2480 RVA: 0x00018008 File Offset: 0x00017408
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009B1 RID: 2481 RVA: 0x00018228 File Offset: 0x00017628
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009B2 RID: 2482 RVA: 0x0001833C File Offset: 0x0001773C
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009B3 RID: 2483 RVA: 0x00018450 File Offset: 0x00017850
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009B4 RID: 2484 RVA: 0x00018564 File Offset: 0x00017964
		[HandleProcessCorruptedStateExceptions]
		...
		// Token: 0x060009B5 RID: 2485 RVA: 0x00017368 File Offset: 0x00016768
		[HandleProcessCorruptedStateExceptions]
