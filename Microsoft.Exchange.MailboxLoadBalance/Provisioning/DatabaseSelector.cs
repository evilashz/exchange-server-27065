...
namespace Microsoft.Exchange.MailboxLoadBalance.Provisioning
{
	...
	{
		// Token: 0x06000684 RID: 1668 RVA: 0x00012579 File Offset: 0x00010779
		public DatabaseSelector(ILogger logger)
		{
			this.logger = logger;
		}

		// Token: 0x06000685 RID: 1669 RVA: 0x00012588 File Offset: 0x00010788
		...
		// Token: 0x06000686 RID: 1670 RVA: 0x00012854 File Offset: 0x00010A54
		protected virtual IEnumerable<LoadContainer> GetAvailableDatabases()
		{
			yield break;
		}

		// Token: 0x06000687 RID: 1671 RVA: 0x00012A44 File Offset: 0x00010C44
