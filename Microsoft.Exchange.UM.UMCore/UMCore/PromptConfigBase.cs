...
namespace Microsoft.Exchange.UM.UMCore
{
	...
	{
		// Token: 0x060006BB RID: 1723 RVA: 0x0001B20C File Offset: 0x0001940C
		...
		// (get) Token: 0x060006BC RID: 1724 RVA: 0x0001B27A File Offset: 0x0001947A
		...
		// (get) Token: 0x060006BD RID: 1725 RVA: 0x0001B2A1 File Offset: 0x000194A1
		...
		// (get) Token: 0x060006BE RID: 1726 RVA: 0x0001B2A9 File Offset: 0x000194A9
		...
		// (get) Token: 0x060006BF RID: 1727 RVA: 0x0001B2B1 File Offset: 0x000194B1
		...
		// (get) Token: 0x060006C0 RID: 1728 RVA: 0x0001B2B9 File Offset: 0x000194B9
		// (set) Token: 0x060006C1 RID: 1729 RVA: 0x0001B2C1 File Offset: 0x000194C1
		...
		// (get) Token: 0x060006C2 RID: 1730 RVA: 0x0001B2CA File Offset: 0x000194CA
		// (set) Token: 0x060006C3 RID: 1731 RVA: 0x0001B2D2 File Offset: 0x000194D2
		...
		// (get) Token: 0x060006C4 RID: 1732 RVA: 0x0001B2DB File Offset: 0x000194DB
		// (set) Token: 0x060006C5 RID: 1733 RVA: 0x0001B2E3 File Offset: 0x000194E3
		...
		// (get) Token: 0x060006C6 RID: 1734 RVA: 0x0001B2EC File Offset: 0x000194EC
		// (set) Token: 0x060006C7 RID: 1735 RVA: 0x0001B2F4 File Offset: 0x000194F4
		...
		// (get) Token: 0x060006C8 RID: 1736 RVA: 0x0001B2FD File Offset: 0x000194FD
		...
		// Token: 0x060006C9 RID: 1737 RVA: 0x0001B305 File Offset: 0x00019505
		public object Clone()
		{
			return base.MemberwiseClone();
		}

		// Token: 0x060006CA RID: 1738 RVA: 0x0001B310 File Offset: 0x00019510
		...
		// Token: 0x060006CB RID: 1739 RVA: 0x0001B420 File Offset: 0x00019620
		...
		// Token: 0x060006CC RID: 1740 RVA: 0x0001B458 File Offset: 0x00019658
		...
		// Token: 0x060006CD RID: 1741 RVA: 0x0001B488 File Offset: 0x00019688
		internal static PromptConfigBase Create(string configName, string configType, string conditionString, string suffix, string prosodyRate, string language, string limitKey, string parentScope, ActivityManagerConfig managerConfig, List<PromptConfigBase> parameters)
		{
			...
			if (configType != null)
			{
				if (<PrivateImplementationDetails>{40E2B4CE-6A40-4DA1-B0B4-CD6B52D7182A}.$$method0x60006b1-1 == null)
				{
					<PrivateImplementationDetails>{40E2B4CE-6A40-4DA1-B0B4-CD6B52D7182A}.$$method0x60006b1-1 = new Dictionary<string, int>(34)
					{
						{
							"statement",
							0
				...
				int num;
				if (<PrivateImplementationDetails>{40E2B4CE-6A40-4DA1-B0B4-CD6B52D7182A}.$$method0x60006b1-1.TryGetValue(configType, out num))
				{
		...
		// Token: 0x060006CE RID: 1742 RVA: 0x0001B978 File Offset: 0x00019B78
		...
		// Token: 0x060006D0 RID: 1744 RVA: 0x0001BA30 File Offset: 0x00019C30
		...
		// Token: 0x060006D1 RID: 1745 RVA: 0x0001BA90 File Offset: 0x00019C90
		internal string GetConditionString()
		{
			return this.conditionString ?? string.Empty;
		}

		// Token: 0x060006D2 RID: 1746 RVA: 0x0001BAA1 File Offset: 0x00019CA1
		...
		// Token: 0x060006D3 RID: 1747 RVA: 0x0001BACA File Offset: 0x00019CCA
		internal virtual string GetSuffixVariable(ActivityManager m)
		{
			throw new NotImplementedException();
		}

		// Token: 0x060006D4 RID: 1748 RVA: 0x0001BAD4 File Offset: 0x00019CD4
		...
		// Token: 0x060006D5 RID: 1749 RVA: 0x0001BB08 File Offset: 0x00019D08
