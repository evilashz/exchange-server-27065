...
namespace Microsoft.Exchange.Monitoring.ActiveMonitoring.Directory
{
	...
	public sealed class DirectoryDiscovery : MaintenanceWorkItem
	{
		...
		// (get) Token: 0x06000917 RID: 2327 RVA: 0x00035142 File Offset: 0x00033342
		// (set) Token: 0x06000918 RID: 2328 RVA: 0x0003514A File Offset: 0x0003334A
		internal DumpMode DirectoryServiceRestartDumpMode { get; private set; }

		// Token: 0x17000204 RID: 516
		// (get) Token: 0x06000919 RID: 2329 RVA: 0x00035153 File Offset: 0x00033353
		// (set) Token: 0x0600091A RID: 2330 RVA: 0x0003515B File Offset: 0x0003335B
		internal int ADConnectivityProbeThreshold { get; private set; }

		// Token: 0x17000205 RID: 517
		// (get) Token: 0x0600091B RID: 2331 RVA: 0x00035164 File Offset: 0x00033364
		// (set) Token: 0x0600091C RID: 2332 RVA: 0x0003516C File Offset: 0x0003336C
		internal bool KDCStartOnProvisionDCEnabled { get; private set; }

		// Token: 0x17000206 RID: 518
		// (get) Token: 0x0600091D RID: 2333 RVA: 0x00035175 File Offset: 0x00033375
		// (set) Token: 0x0600091E RID: 2334 RVA: 0x0003517D File Offset: 0x0003337D
		internal bool KDCStopOnMMDCEnabled { get; private set; }

		// Token: 0x17000207 RID: 519
		// (get) Token: 0x0600091F RID: 2335 RVA: 0x00035186 File Offset: 0x00033386
		// (set) Token: 0x06000920 RID: 2336 RVA: 0x0003518E File Offset: 0x0003338E
		internal int ServiceStartStopRetryCount { get; private set; }

		// Token: 0x17000208 RID: 520
		// (get) Token: 0x06000921 RID: 2337 RVA: 0x00035197 File Offset: 0x00033397
		// (set) Token: 0x06000922 RID: 2338 RVA: 0x0003519F File Offset: 0x0003339F
		internal int LiveIdProbeLatencyThreshold { get; private set; }

		// Token: 0x17000209 RID: 521
		// (get) Token: 0x06000923 RID: 2339 RVA: 0x000351A8 File Offset: 0x000333A8
		// (set) Token: 0x06000924 RID: 2340 RVA: 0x000351B0 File Offset: 0x000333B0
		internal int ReplicationThresholdInMins { get; private set; }

		// Token: 0x1700020A RID: 522
		// (get) Token: 0x06000925 RID: 2341 RVA: 0x000351B9 File Offset: 0x000333B9
		// (set) Token: 0x06000926 RID: 2342 RVA: 0x000351C1 File Offset: 0x000333C1
		internal double PercentageOfDCsThresholdExcludedForADHealth { get; private set; }

		// Token: 0x06000927 RID: 2343 RVA: 0x000351CC File Offset: 0x000333CC
		...
		// Token: 0x06000928 RID: 2344 RVA: 0x00036608 File Offset: 0x00034808
		...
		// Token: 0x06000929 RID: 2345 RVA: 0x00036928 File Offset: 0x00034B28
		...
		// Token: 0x0600092A RID: 2346 RVA: 0x0003696C File Offset: 0x00034B6C
		...
		// Token: 0x0600092B RID: 2347 RVA: 0x000371F0 File Offset: 0x000353F0
